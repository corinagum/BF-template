export default () => ({
      ...
      items: [
        {
          ...
          size: 'medium',
          spacing: 'none',
          text: 'PRO Sports Club Coffee Shop',
          type: 'TextBlock',
          weight: 'bolder'
        },
        {
        ...
        },
        {
          ...
          separation: 'none',
          spacing: 'none',
          text: '4455 148th Ave NE, Bellevue',
          type: 'TextBlock',
          wrap: true
        },
        {
      ...
      items: [
        {
          ...
          horizontalAlignment: 'center',
          type: 'Image',
          altText: 'Image of grilled cheese sandwhich',
          url: 'https://fastly.4sqi.net/img/general/612x612/UAgeVGfC5YaQPjPfSgU2LIEMSWR_Oql1yDVMiRVy8jI.jpg',
          width: '380px'
        }
      ],
      separator: true,
      ...
      items: [
        {
          ...
          size: 'small',
          text: 'Powered by **Azure Maps & Foursquare**',
          type: 'TextBlock'
        }
      ],
      separator: true,
  ...
  speak: 'PRO Sports Club Coffee Shop at 4455 148th Ave NE',
  type: 'AdaptiveCard',
  version: '1.0'
});
